...
public class Grid : MonoBehaviour
{
    ...
    public Node NodeFromWorldPoint(Vector3 worldPosition)
    {
        ...
        float percentY = (worldPosition.z + gridWorldSize.y / 2.0f) / gridWorldSize.y;
    ...
    void OnDrawGizmos()
    {
        Gizmos.DrawWireCube(transform.position, new Vector3(gridWorldSize.x, 2.0f, gridWorldSize.y));
